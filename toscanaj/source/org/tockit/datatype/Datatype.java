...
public interface Datatype extends XMLizable {
     ...
     * 
     * This can be done either by adding a "value" attribute or by adding
     * content. Both are in the default namespace, but which way is used depends
     * on the actual type implementation.
     * 
     * @throws ClassCastException
     *             if the value is not of matching type
     */
