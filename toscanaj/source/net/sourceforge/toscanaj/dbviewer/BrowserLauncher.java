/*
 * BrowserLauncher from http://browserlauncher.sourceforge.net/
 * 
...
public class BrowserLauncher {
    ...
    private static boolean loadClasses() {
        switch (jvm) {
            case MRJ_2_0:
                try {
                    final Class aeTargetClass = Class
                            .forName("com.apple.MacOS.AETarget");
                    final Class osUtilsClass = Class
                    ...
                    final Field keyDirectObjectField = aeClass
                            .getDeclaredField("keyDirectObject");
                    keyDirectObject = (Integer) keyDirectObjectField.get(null);
                    final Field autoGenerateReturnIDField = appleEventClass
                            .getDeclaredField("kAutoGenerateReturnID");
                    kAutoGenerateReturnID = (Integer) autoGenerateReturnIDField
                            .get(null);
                    final Field anyTransactionIDField = appleEventClass
                            .getDeclaredField("kAnyTransactionID");
                    kAnyTransactionID = (Integer) anyTransactionIDField
                            .get(null);
            ...
            case MRJ_3_0:
                try {
                    final Class linker = Class
                            .forName("com.apple.mrj.jdirect.Linker");
                    final Constructor constructor = linker
                            .getConstructor(new Class[] { Class.class });
                    // @todo I removed an assignment to a private static member
                    // here since that wasn't used
        ...
        switch (jvm) {
            ...
            case MRJ_2_1:
                Runtime.getRuntime().exec(
                        new String[] { (String) currentBrowser, url });
                break;
            case MRJ_3_0:
            ...
            case MRJ_3_1:
                ...
                break;
            case WINDOWS_NT:
                final Process processNT = Runtime.getRuntime().exec(
                        new String[] { (String) currentBrowser,
