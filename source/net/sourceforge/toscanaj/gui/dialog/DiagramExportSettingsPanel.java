...
public class DiagramExportSettingsPanel extends JComponent implements ActionListener {
	...
	private JPanel createModePanel() {
		this.useScrSizeCheckBox = new JCheckBox("Use Screen Size",this.diagramSettings.usesAutoMode());
		...
		this.widthField.setText(String.valueOf(this.diagramSettings.getImageWidth()));
		...
		this.heightField.setText(String.valueOf(this.diagramSettings.getImageHeight()));
...
//		modePanel.setBorder(BorderFactory.createTitledBorder("Size"));
		...
		modePanel.add(this.useScrSizeCheckBox, new GridBagConstraints(0, 0, 1, 1, 0.0,0.0, 
			GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(0, 5, 5, 5), 0, 0));

		modePanel.add(this.widthLabel, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
		 	GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL, new Insets(5, 5, 5, 5), 0, 0));
		
		modePanel.add(this.widthField, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
		  	GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL, new Insets(5, 50, 5, 5), 0, 0));
		
		modePanel.add(this.heightLabel, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0,
		  	GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL, new Insets(5, 5, 5, 5), 0, 0));
		
		modePanel.add(this.heightField, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0,
		 	GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL, new Insets(5, 50, 5, 5), 0, 0));		
...
//		historyPanel.setBorder(BorderFactory.createTitledBorder("History Export"));
		this.saveToFileCheckBox = new JCheckBox("Save history to file", this.diagramSettings.getSaveCommentsToFile());
		this.copyToClipboardCheckBox = new JCheckBox("History to clipboard", this.diagramSettings.getSaveCommentToClipboard());
		historyPanel.add(this.saveToFileCheckBox, new GridBagConstraints(0, 0, 1, 1, 1.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 5, 0, 5), 0, 0));
		historyPanel.add(this.copyToClipboardCheckBox, new GridBagConstraints(0, 1, 1, 1, 1.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 5, 0, 5), 0, 0));
		return historyPanel;
	}
        ...
        this.backgroundColorButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Color newColor = JColorChooser.showDialog(
                                parent, "Select background color", DiagramExportSettingsPanel.this.backgroundColorButton.getBackground());
                DiagramExportSettingsPanel.this.backgroundColorButton.setBackground(newColor);
            }
        });
