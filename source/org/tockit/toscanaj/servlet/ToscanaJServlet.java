...
public class ToscanaJServlet extends HttpServlet {
    ...
    private void printDiagram(int diagramNumber, DiagramHistory diagramHistory, PrintWriter out) {
        ...
        for(int i = 0; i < numNodes; i ++) {
            ...
            Color nodeColor = diagramSchema.getBottomColor();
            ...
            if(objLabel != null) {
                ...
                int objectCount = conceptInterpreter.getObjectCount(
                                                            concept,
    ...
    private void printHead(PrintWriter out) {
        ...
        out.println("<svg width=\"" + IMAGE_WIDTH + "\" height=\"" + IMAGE_HEIGHT + "\" xmlns=\"http://www.w3.org/2000/svg\">");
    }
