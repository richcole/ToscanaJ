...
<conceptualSchema version="1.0" askDatabase="true" xsi:noNamespaceSchemaLocation="http://meganesia.int.gu.edu.au/projects/ToscanaJ/schemas/csx.xsd" xmlns:xsi="http://www.w3.org/2000/10/XMLSchema-instance">
	<database>
		<dsn>PCTEST80</dsn>
		<table>PC-Test</table>
	...
	<diagram title="Zugängliche Laufwerke">
		<concept id="1">
			...
			<attributeContingent>
				<labelStyle>
					<offset x="-21" y="14.399999999999998" />
					<textAlignment>right</textAlignment>
				</labelStyle>
		...
		<concept id="5">
			...
			<attributeContingent>
				<labelStyle>
					<offset x="-5.4" y="16.799999999999997" />
					<textAlignment>right</textAlignment>
				</labelStyle>
		...
		<concept id="9">
			...
			<attributeContingent>
				<labelStyle>
					<offset x="-6.6000000000000005" y="18" />
					<textAlignment>right</textAlignment>
				</labelStyle>
		...
		<concept id="13">
			...
			<attributeContingent>
				<labelStyle>
					<offset x="-13.200000000000001" y="16.799999999999997" />
					<textAlignment>right</textAlignment>
				</labelStyle>
		...
		<concept id="17">
			...
			<attributeContingent>
				<labelStyle>
					<offset x="-9.600000000000001" y="19.200000000000003" />
					<textAlignment>right</textAlignment>
				</labelStyle>
		...
		<concept id="21">
			...
			<attributeContingent>
				<labelStyle>
					<offset x="-9" y="14.399999999999998" />
					<textAlignment>right</textAlignment>
				</labelStyle>
		...
		<concept id="25">
			...
			<attributeContingent>
				<labelStyle>
					<offset x="-8.399999999999998" y="18" />
					<textAlignment>right</textAlignment>
				</labelStyle>
		...
		<concept id="29">
			...
			<attributeContingent>
				<labelStyle>
					<offset x="-12" y="16.799999999999997" />
					<textAlignment>right</textAlignment>
				</labelStyle>
	...
	<diagram title="interne Laufwerksschächte">
		...
		<concept id="3">
			...
			<attributeContingent>
				<labelStyle>
					<offset x="-15.600000000000001" y="21" />
					<textAlignment>right</textAlignment>
				</labelStyle>
		...
		<concept id="4">
			...
			<attributeContingent>
				<labelStyle>
					<offset x="-16.799999999999997" y="20.4" />
					<textAlignment>right</textAlignment>
				</labelStyle>
		...
		<concept id="17">
			...
			<attributeContingent>
				<labelStyle>
					<offset x="-18" y="19.799999999999997" />
					<textAlignment>right</textAlignment>
				</labelStyle>
	...
	<diagram title="Ports auf dem Motherboard">
		...
		<concept id="2">
			...
			<attributeContingent>
				<labelStyle>
					<offset x="-12.600000000000001" y="18" />
					<textAlignment>right</textAlignment>
				</labelStyle>
		...
		<concept id="4">
			...
			<attributeContingent>
				<labelStyle>
					<offset x="9.600000000000001" y="16.200000000000003" />
					<textAlignment>left</textAlignment>
				</labelStyle>
		...
		<concept id="6">
			...
			<attributeContingent>
				<labelStyle>
					<offset x="-7.199999999999999" y="19.200000000000003" />
					<textAlignment>right</textAlignment>
				</labelStyle>
