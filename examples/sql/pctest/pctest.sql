CREATE TABLE PCTest (
  ...
  harddisk int(2) default NULL,
  CPU float default NULL,
  RAM float default NULL,
  video bigint(4) default NULL,
  disk float default NULL,
  dosmark float default NULL,
  graphics float default NULL,
  diskmark float default NULL,
  dealer tinyint(1) default NULL,
  directsales tinyint(1) default NULL,
  typeCase varchar(255) default NULL,
  typeBus varchar(10) default NULL,
  powerSupply int(2) default NULL,
  powerConnectors int(1) default NULL,
  upgradability varchar(255) default NULL,
  numericPUSocket varchar(255) default NULL,
  cacheArchitecture varchar(255) default NULL,
  cachewrite varchar(255) default NULL,
  freeDriveSlots int(2) default NULL,
  internalDriveSlots int(2) default NULL,
  diskDrives varchar(255) default NULL,
  hardDiskBays varchar(255) default NULL,
  hardDiskController varchar(255) default NULL,
  slots8bit int(2) default NULL,
  slots16bit int(2) default NULL,
  slotsEISA int(2) default NULL,
  slotsMCA int(2) default NULL,
  slotsOther int(2) default NULL,
  slotsLocalBus int(2) default NULL,
  ports varchar(255) default NULL,
  network varchar(255) default NULL,
  graphiccard varchar(255) default NULL,
  DOSWIN varchar(255) default NULL,
  software varchar(255) default NULL,
  warranty varchar(255) default NULL,
  service varchar(255) default NULL,
  largeDrives int(2) default NULL,
  smallDrives int(2) default NULL,
  largeInternalDrives int(2) default NULL,
  smallInternalDrives int(2) default NULL,
